...
final class Plugin {
	 ...
	 * @access private
	 * @static
	 * @var \Schlack_Addon\Plugin The single instance of the class.
	 */
	...
	public function custom_categories( $elements_manager ) {
		...
		$elements_manager->add_category(
			'schlack',
			[
				'title' => esc_html__( 'Schlack', 'schlack-addon' ),
				'icon' => 'fa fa-plug',
			]
		);
	...
	public function register_widgets( $widgets_manager ) {
		...
		$widgets_manager->register( new \Schlack_Addon\Ko_Legal_Services() );
